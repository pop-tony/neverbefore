    ...
    <section className="bg-[#F8F5F1] px-4 py-20 text-zinc-900 dark:bg-[#0C0C0E] dark:text-white">
      <div className="mx-auto max-w-7xl">
        <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#C5A059]">Curated collection</p>
            <h2 className="mt-3 font-serif text-4xl font-semibold tracking-[-0.04em] md:text-5xl">{content?.shop_heading || 'Gold Rituals'}</h2>
            <p className="mt-3 max-w-xl text-zinc-600 dark:text-zinc-400">{content?.shop_subheading || 'A small edit of formulas our customers actually repurchase.'}</p>
          </div>
